...
def create_general_window():
    ...
    canvas.create_text(470, 80, text="Covid-19", fill="White", font=('Arial', 40))
    ...
    Button_Europe_first_window = Button(canvas,
                                        ...
                                        font=('Arial', 13),
                                        width=11, height=2)
    Button_Europe_first_window.place(x=370, y=240)
    Button_Ukraine_first_window = Button(canvas,
                                         text='Ukraine',
                                         bg='White', fg='Black',
                                         font=('Arial', 13),
                                         width=11, height=2)
    Button_Ukraine_first_window.place(x=500, y=240)
